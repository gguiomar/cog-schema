...
# Function to create a Hugging Face Dataset from the temporal data.
...
#Fastest to upload, smallest footprint
model.save_lora("/content/drive/MyDrive/trt_reasoning/lora_weights")
#to load:
# model.load_lora("/content/drive/MyDrive/trt_reasoning/lora_weights")


#Saving the Full Model + Tokenizer (Larger, but self‑contained)
model.save_pretrained("/content/drive/MyDrive/trt_reasoning/full_model")
tokenizer.save_pretrained("/content/drive/MyDrive/trt_reasoning/full_model")

# Then model and tokenizer can be called:

#from unsloth import FastLanguageModel

# model, tokenizer = FastLanguageModel.from_pretrained(
#     "/content/drive/MyDrive/trt_reasoning/full_model",
#     load_in_4bit=True,
#     fast_inference=True,
# )


# #in case someone wants to get things local (idk why)
