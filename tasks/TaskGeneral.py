...
class TaskGeneral:
    ...
    def get_trial_separator(self) -> Optional[str]:
        try:
            prompt = load_prompt_from_xml(self.strings, 'trial_separator', self.prompt_version)
    ...
    def get_initial_prompt(self):
        try:
            prompt = load_prompt_from_xml(self.strings, 'initial_prompt', self.prompt_version)
    ...
    def get_intermediate_prompt(self) -> str:
        try:
            ...
            prompt = load_prompt_from_xml(self.strings, 'intermediate_prompt', self.prompt_version)
